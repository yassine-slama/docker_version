...
const EditStaff = () => {
    ...
    console.log("edit Staff ID = " + edit);
    ...
    useEffect(() => {
        const token = localStorage.getItem('token');
        if (profile && edit) {
          fetch(`${process.env.NEXT_PUBLIC_SITE_URL}/api/staff/get-one/${edit}`, {
            headers: {
              Authorization: `${token}`,
            },
          })
...
// // ##################################################################################################################################
      ...
      const handleSubmit = (e) => {
        ...
        fetch(`${process.env.NEXT_PUBLIC_SITE_URL}/api/staff/update-one/${edit}`, {
          method: 'PUT',
          headers: {
          ...
          .then((updatedData) => {
            ...
            toast.current.show({severity:'success', summary: 'Updated !', detail:'Staff Updated Successfully', life: 3000});
            setTimeout(() => {
                router.push('/staff');
            }, 500);
          })
